  ...
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      <el-form-item label="赠品名称" prop="giftsName">
        <el-input placeholder="请输入订单名称" v-model="ruleForm.giftsName"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          PutApi(`/api/gifts/update/`, this.ruleForm).then((data) => {
  ...
  mounted() {
    ...
    this.ruleForm.giftsId = this.$route.query.id;
    GetAPI('/api/gifts/get?id=' + this.$route.query.id).then((res) => {
      let obj=res.data.data;
      this.ruleForm.giftsName=obj.giftsName;
      this.ruleForm.giftsAge=obj.giftsAge;
      this.ruleForm.giftTypeId=obj.giftTypeId;
      this.ruleForm.giftTime=obj.giftTime;
      this.ruleForm.giftsSource=obj.giftsSource
      this.ruleForm.giftsPeriod=obj.giftsPeriod;
      this.ruleForm.giftsNumber=obj.giftsNumber;
      this.ruleForm.giftsPrize=obj.giftsPrize;
      this.ruleForm.giftsDamageNumber=obj.giftsDamageNumber
      this.ruleForm.giftsDamageCause=obj.giftsDamageCause;
