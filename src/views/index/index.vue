...
<!--                        <div class="index-head-centent-right-list">-->
<!--                            <div class="index-head-centent-right-list-icon">-->
<!--                                <github style="color: #2294FC; background: #DDEDFD;" class="index-head-centent-right-list-icon-is"  /> 惠民项目-->
<!--                            </div>-->
<!--                            <div class="index-head-centent-right-list-text">-->
<!--                                7-->
<!--                            </div>-->
...
<!--                    &lt;!&ndash; 项目 &ndash;&gt;-->
<!--                    &lt;!&ndash; <div class="grid-content">-->
<!--                        <div class="index-centent-title"> &ndash;&gt;-->
<!--                            &lt;!&ndash; <div class="index-centent-title-left">-->
...
<!--                            </div> &ndash;&gt;-->
<!--                        &lt;!&ndash; </div> &ndash;&gt;-->
<!--                        &lt;!&ndash; <div class="index-centent-box">-->
<!--                            <Project />-->
<!--                        </div> &ndash;&gt;-->
<!--                    &lt;!&ndash; </div> &ndash;&gt;-->
<!--                    &lt;!&ndash; 动态 &ndash;&gt;-->
...
export default {
    ...
    mounted(){
        this.name1=localStorage.getItem('user_name')
    },
  methods: {
    // 路由跳转
    navigateTo(name) {
